...
export type ProjectQuery = { project: { projectId: number, metadataUri: string | null, handle: string | null, createdAt: number, suckerGroupId: string, logoUri: string | null, name: string | null, version: number, suckerGroup: { projects: { items: Array<{ chainId: number, balance: any, tokenSupply: any }> } | null } | null } | null };
